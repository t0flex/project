...
--
-- Host: localhost    Database: openserver
-- ------------------------------------------------------
...
INSERT INTO `categories` VALUES (1,'Изображения','pictures'),(2,'Документы','docx'),(3,'Разное','another');
...
CREATE TABLE `files` (
  ...
  KEY `files___fk_users` (`user_id`),
  CONSTRAINT `files___fk_users` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2021-11-03 22:35:08
